...
const clientCode = (creator: Creator) => {
    console.log(
        `Client: I don't know if the creator class is RED or BLUE, but it still works.`
    );
...
export const factoryTest = () => {
    ...
    console.log(
        '\x1b[34m',
        'Test: Launched with the ConcreteBlueCreator.',
        '\x1b[0m'
    );
    ...
    console.log(
        '\x1b[31m',
        'Test: Launched with the ConcreteRedCreator.',
        '\x1b[0m'
    );
